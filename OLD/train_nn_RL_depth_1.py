...
def generate_data_RL(
    ...
    alpha_player_0 = AlphaZero_player(0, mcts_steps, n_of_sims, nn_scaler, ucb_c, model_name)
    alpha_player_1 = AlphaZero_player(1, mcts_steps, n_of_sims, nn_scaler, ucb_c, model_name)
    alpha_player_2 = AlphaZero_player(2, mcts_steps, n_of_sims, nn_scaler, ucb_c, model_name)
    alpha_player_3 = AlphaZero_player(3, mcts_steps, n_of_sims, nn_scaler, ucb_c, model_name)
