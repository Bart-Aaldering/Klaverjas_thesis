...
ax1.plot(X_10_1, y_10_1, marker, label="10 steps")
ax1.fill_between(X_10_1, np.array(y_10_1) - std_10_1 * 1.98, np.array(y_10_1) + std_10_1 * 1.98, alpha=0.2)

ax1.plot(X_50_1, y_50_1, marker, label="50 steps")
ax1.fill_between(X_50_1, np.array(y_50_1) - std_50_1 * 1.98, np.array(y_50_1) + std_50_1 * 1.98, alpha=0.2)
